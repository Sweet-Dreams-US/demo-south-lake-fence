...
export const media = {
  // South Lake Fence marks — local blue/white SVGs in /public (FENCE-forward).
  logo: `/logo-full.svg`, // stacked mark (og/social)
  logoFull: `/logo-full.svg`, // stacked full-color
  logoNav: `/logo-nav.svg`, // lockup for the nav
  logoFooter: `/logo-footer.svg`, // white mono for dark surfaces
  ...
  field: `${BASE}/field-np.webp`, // field & ranch fence (cattle/pasture)
  ...
  panoField: `${BASE}/pano-field-v2.webp`,
} as const;
